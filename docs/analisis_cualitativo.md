...
*   **Segmentación por estado civil**: Las personas solteras consolidan el grupo mayoritario con un **50.3% del total** analizado a nivel global, mientras que el público casado representa el **43.1%**, posicionándose como el segundo núcleo demográfico más grande del establecimiento.
...
| :--- | :--- | :--- | :--- | :--- |
| **Japonesa** | Muy alto | **3.58** | `+0.36` 🟢 | **Éxito absoluto**: El producto estrella en volumen y satisfacción. |
| **Filipina** | Muy alto | **3.04** | `-0.17` 🔴 | **Riesgo operativo**: Mucho consumo pero baja calidad percibida. |
...
2.  **Rendimiento analítico por procedencia**: Los comensales residentes en **Tamaraceite** lideran la satisfacción general (mediana de 3.5), mientras que los procedentes de **Mesa y López** decaen notablemente (mediana de 3.0). Por su parte, el segmento de **Siete Palmas** sufre una preocupante inestabilidad y opiniones polarizadas, registrando una **varianza de 1.48**.
...
4.  **Insatisfacción familiar**: El segmento de casados (43.1% del público) otorga una puntuación media baja de **2.88**, evidenciando fallas críticas en la experiencia culinaria familiar del establecimiento.
...
3.  **Estandarización de la experiencia del cliente**: Diseñar estrategias operativas específicas enfocadas en los segmentos de comensales procedentes de Siete Palmas (varianza 1.48) y Mesa y López, replicando los estándares de calidad y atención que consolidan la alta satisfacción del flujo de clientes de Tamaraceite.
